...
Dashboards are hosted in [Grafana](https://grafana.com/grafana/) (the internal observability platform).
...
**E2E processing time ([Grafana Loki](https://grafana.com/oss/loki/) EU):**
